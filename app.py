...
st.markdown("""
    ...
    /* Cuadrícula Grid para las 9 Columnas de la Llave */
    .bracket-container {
        display: grid;
...
# VARIABLE DE CONTROL: Cambiar a True si quieres activar el aviso de fuera de servicio
...
if MANTENIMIENTO_ACTIVO:
    st.markdown("""
        <div style="text-align: center; padding: 100px 20px;">
            ...
            <h1 style="color: #1E3A8A; font-weight: 800;">MÓDULO TEMPORALMENTE FUERA DE SERVICIO</h1>
    ...
    if error:
        ...
        st.markdown(f"""
            <div class="bracket-header">
                ...
                <p>Visualización gráfica sincronizada para: <b>{seleccion}</b></p>
            </div>
        """, unsafe_allow_html=True)
